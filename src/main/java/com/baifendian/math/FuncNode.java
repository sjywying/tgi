...
import com.baifendian.struc.Bag;
...
public class FuncNode extends TermNode {
	...
	private RoaringBitmap[] of = new RoaringBitmap[1];
	...
	*/
	public RoaringBitmap eval(VarMap v, FuncMap f) {
		...
		RoaringBitmap result = f.getFunction(name, numParam).of(of, numParam);
